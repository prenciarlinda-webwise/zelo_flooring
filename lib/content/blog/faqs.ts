...
export const BLOG_FAQS: Record<string, BlogFaq[]> = {
  ...
  'roof-leak-water-damage-to-floors': [
    { q: "How do I know if my floor damage is from a roof leak or a plumbing leak?", a: "Roof leaks typically track with rain, show a ceiling stain directly above the damaged flooring, and occur in areas without nearby plumbing fixtures. Plumbing leaks are usually constant or tied to fixture use and occur near a sink, toilet, appliance, or supply line. When it is unclear, a roofing contractor can inspect the attic and roof deck to confirm the source." },
    { q: "Why does roof leak damage often go unnoticed for so long?", a: "Water from a roof leak has to travel through attic insulation, framing, and drywall before it reaches a visible floor, which can take days or weeks. By the time a stain or damp spot appears, the leak has often been active far longer than the visible damage suggests." },
    { q: "Should I fix my floor or my roof first?", a: "Fix the roof first, always. Repairing or replacing flooring before the leak source is confirmed fixed risks the same water damaging the new work in the next rain. We recommend getting written confirmation the roof repair has held through at least one storm before scheduling flooring work." },
    { q: "Can hardwood floors recover from roof leak water damage?", a: "Often yes, if the leak is caught and stopped before the boards buckle. Cupped boards with the finish still intact can usually be dried and refinished. Buckled boards, or boards soaked repeatedly over multiple leak events, typically need to be replaced rather than dried." },
    { q: "Does laminate flooring recover from a roof leak the way hardwood does?", a: "No. Laminate's core swells permanently once water reaches it and does not return to its original shape when dried, unlike solid hardwood. Laminate affected by roof leak water almost always needs to be replaced rather than dried and saved." },
    { q: "What does roof leak floor damage repair cost?", a: "Flooring repair from a roof leak runs $3 to $14 per square foot depending on the material and how long the leak was active, on top of the roof repair cost itself. A small, early-caught stain often costs a few hundred dollars on the flooring side; a full room affected by a long-term undetected leak can run several thousand." },
    { q: "Will homeowners insurance cover roof leak water damage to my floors?", a: "Often yes for sudden damage, like a storm-caused roof failure, but frequently excluded if the leak was caused by long-term deferred roof maintenance. A written assessment from a roofing contractor documenting the cause helps clarify which category a specific claim falls into." },
    { q: "Do I need to check the subfloor after a roof leak, even if the visible flooring looks fine?", a: "Yes. A roof leak that dripped intermittently for weeks can saturate plywood subfloor even when the surface flooring above it still looks mostly normal, especially under tile or LVP. We check subfloor moisture on every roof-leak call for this reason." },
  ],

  'paint-before-or-after-flooring': [
    { q: "Should I paint before or after installing new flooring?", a: "Paint before installing new flooring in almost every case. Painting first protects the new floor from drips and ladder traffic, and the floor being replaced or the bare subfloor underneath does not need the same protection during the messier painting phase." },
    { q: "Should I paint before or after refinishing hardwood floors?", a: "Paint first, then let it fully cure before refinishing starts. Sanding an existing hardwood floor creates fine dust that settles on walls, and dust embeds more easily in paint that has not fully cured yet than in paint that has had a week or more to harden." },
    { q: "Does carpet installation need to happen after all painting is done?", a: "Yes, including trim touch-ups. Once carpet pile is down, a paint drip is much harder to clean out than off a hard floor, and carpet installers need finished baseboards to trim the edge against cleanly. Finish all painting before scheduling a carpet install." },
    { q: "How long should paint cure before flooring goes in?", a: "Plan for at least 5 to 7 days of cure time after the final coat before flooring installation or hardwood refinishing begins, longer in a poorly ventilated or humid room. Paint that is dry to the touch is not the same as paint that has fully cured and hardened." },
    { q: "Do baseboards get painted before or after new flooring?", a: "Baseboard touch-up paint happens after flooring installation, so it can cover any scuffs from the install and give a clean line against the finished floor and its expansion gap. An initial coat of primer and paint on new baseboards can happen earlier, but the final touch-up coat comes last." },
    { q: "Will a hardwood refinish damage fresh paint?", a: "It can, mainly through sanding dust settling on walls and edge-sanding equipment nicking baseboards, rather than from moisture or chemicals. Painting first and letting it fully cure, then protecting baseboards during the sand, keeps this risk low." },
    { q: "Is the paint-then-flooring order different for a new construction home?", a: "New construction follows a longer sequence: framing, drywall, paint or primer, cabinets, flooring, then baseboards and trim, since more trades are involved before flooring goes in. For a room renovation in an existing home, the shorter paint-then-flooring-then-trim order covered in this guide applies." },
    { q: "Can I paint the same day flooring is installed?", a: "We do not recommend it. Fresh flooring, especially glued-down or finished-on-site hardwood, needs time to off-gas and cure without paint fumes or overspray in the room, and wet paint is easily damaged by material staging and foot traffic during an install. Space the two trades out by at least a few days." },
  ],
};
